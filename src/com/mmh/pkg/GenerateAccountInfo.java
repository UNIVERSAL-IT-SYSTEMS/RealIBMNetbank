...
@WebServlet("/GenerateAccountInfo")
public class GenerateAccountInfo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("Nu er vi herinde i GenerateAccInfo");	
		...
		try {
			...
			context.getRequestDispatcher("frontPageCostumer.jsp").forward(request, response);
			//request.getRequestDispatcher("frontPageCostumer.jsp").forward(request, response);
			System.out.println("Efter - GenerateAccountInfo");
			accountList.clear();
			return;
